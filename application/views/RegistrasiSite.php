    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Registration Form Mangsi</h2>
                    <div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nama_pelanggan" value="<?php echo set_value('nama_pelanggan'); ?>">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email_pelanggan" value="<?php echo set_value('email_pelanggan'); ?>">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="katasandi_pelanggan2">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Nomor Telpon</label>
                                    <input class="input--style-4" type="text" name="nomor_telepon_pelanggan">
                                    <small class="text-danger"><?php echo form_error('nomor_telepon_pelanggan') ?></small>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Alamat Rumah</label>
                                    <input class="input--style-4" type="text" name="alamat_pelanggan">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="Birthdate">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">Male
                                            <input type="radio" checked="checked" name="gender_pelanggan">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">Female
                                            <input type="radio" name="gender_pelanggan">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
